...
Map made with Natural Earth. Free vector and raster map data &copynaturalearthdata.com. Note that this reproduces Figure 5 (left) from https://doi.org/10.5194/amt-9-2425-2016 (but that was obtained with a different plotting package and different colors and classes).
