...
Note that this reproduces Figure 5 (left) from https://doi.org/10.5194/amt-9-2425-2016 (but that was obtained with a different plotting package).
...
Note that this reproduces Figure 5 (right) from https://doi.org/10.5194/amt-9-2425-2016 (but that was obtained with a different plotting package). This map can be compared with the CML-based rainfall map given above for the same time interval.
