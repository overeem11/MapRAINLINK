...
This script is meant as a replacement of the visualization by the open-source R package RAINLINK for Dutch radar data and commercial microwave link data. It can be of use for opportunistic sensing data, such as those from CML and personal weather stations (PWS).
