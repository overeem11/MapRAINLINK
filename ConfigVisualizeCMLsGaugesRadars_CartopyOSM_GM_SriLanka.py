...
OutputFileName = "SriLanka.jpg"			# Name of output file with map. Can at least be "jpg", "pdf" or "png", which automatically chooses the file format.
...
OPERARadarInputFileName = "RAD_OPERA_24H_RAINFALL_ACCUMULATION_201305311400.h5"	# Filename of file with grided radar rainfall data.
